...
public class ObjectHelper {
	...
	@SneakyThrows
	public static <T> T toInstances(TypeReference<T> clazz, String jsonPath, ResultActions resultActions){
		return objectMapper.readValue(JsonPath.read(resultActions.andReturn().getResponse().getContentAsString(), jsonPath).toString(), clazz);
	}

	@SneakyThrows
	public static <T> T toInstances(TypeReference<T> clazz, ResultActions resultActions){
...
//		parameters.setAll(objectMapper.convertValue(object, new TypeReference<Map<String, String>>() {}));
		parameters.setAll(CamelCaseJsonHelper.objectMapper.convertValue(object, new TypeReference<Map<String, String>>() {}));
		return parameters;
	}
